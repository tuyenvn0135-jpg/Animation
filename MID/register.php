...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->get_result()->num_rows > 0) {
        ...
        if ($ins->execute()) {
            $msg = "✔️ Đăng ký tài khoản thành công! <a href='MID/login.php' class='text-blue-600 underline font-bold'>Đăng nhập ngay</a>";
        } else {
...
<div class="container mx-auto px-4 py-12 max-w-md">
    <div class="bg-white p-8 rounded-xl shadow-sm border">
        ...
        <form action="MID/register.php" method="POST" class="space-y-4 text-xs font-medium">
            <div>
        ...
        <p class="text-center text-[11px] text-gray-400 mt-4">Đã có tài khoản? <a href="MID/login.php" class="text-[#FF9F1C] font-bold underline">Đăng nhập</a></p>
    </div>
</div>
