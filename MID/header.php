    ...
    <header class="bg-[#0A2540] text-white sticky top-0 z-50 shadow-md">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <nav class="hidden md:flex items-center space-x-6 text-sm font-semibold text-slate-300">
                <<a href="<?php echo $base_url; ?>index.php" class="hover:text-white transition">Trang Chủ</a>
<a href="<?php echo $base_url; ?>MID/blog.php" class="hover:text-white transition">Cẩm Nang Cần Thủ</a>
<a href="<?php echo $base_url; ?>MID/cart.php" class="hover:text-white transition">Giỏ Hàng</a>
<a href="<?php echo $base_url; ?>MID/contact.php" class="hover:text-amber-400 transition">Liên Hệ</a>
...
<span class="text-slate-400">Chào, <a href="<?php echo $base_url; ?>profile.php" class="text-amber-400 font-bold hover:underline">👤 <?php echo htmlspecialchars($_SESSION['fullname']); ?></a></span>
<span class="text-slate-600">|</span>
<a href="<?php echo $base_url; ?>MID/logout.php" class="text-red-400 hover:underline">Thoát</a>
<?php else: ?>
<a href="<?php echo $base_url; ?>MID/login.php" class="hover:text-amber-400 transition">Đăng Nhập</a>
<span class="text-slate-600">|</span>
<a href="<?php echo $base_url; ?>MID/register.php" class="text-amber-400 hover:underline">Đăng Ký</a>
<?php endif; ?>
</div>
...
<span class="text-slate-400">Chào, <a href="profile.php" class="text-amber-400 font-bold underline">👤 <?php echo htmlspecialchars($_SESSION['fullname']); ?></a></span>
