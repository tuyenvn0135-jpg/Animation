    ...
    <aside class="w-64 bg-slate-900 text-slate-300 flex flex-col justify-between hidden md:flex">
        <div>
            ...
            <nav class="p-4 space-y-2 text-sm font-medium">
                ...
                <a href="admin_orders.php" class="block bg-slate-800 text-white px-4 py-3 rounded transition">📋 Quản lý Đơn hàng</a>
                        ...
                        <?php if ($orders && $orders->num_rows > 0): ?>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="p-4 text-center">
                                    <form action="admin_orders.php" method="POST" class="flex items-center justify-center space-x-1">
