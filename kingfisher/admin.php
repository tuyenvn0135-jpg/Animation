    ...
    <aside class="w-64 bg-slate-900 text-slate-300 flex flex-col justify-between hidden md:flex">
        <div>
            ...
            <nav class="p-4 space-y-2 text-sm font-medium">
                ...
                <a href="#" onclick="alert('Tính năng quản lý thành viên đang được đồng bộ.')" class="block hover:bg-slate-800 hover:text-white px-4 py-3 rounded transition">👥 Quản lý Thành viên</a>
        ...
        <div class="p-4 bg-slate-950 text-xs text-center border-t border-slate-800">
            ...
            <a href="logout.php" class="block text-red-400 hover:underline mt-1">Đăng xuất</a>
        </div>
    </aside>
